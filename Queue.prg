...
Function PushMotionCmdQueue$(ByVal cmd_id$ As String,ByVal cmd_name$ As String,ByVal completed_cmd_string$ As String,ByVal args_count As Integer) As String
